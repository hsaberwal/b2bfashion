...

{
  ...
  "pricePerPiece": "the per-garment wholesale price as a number (no currency symbol), e.g. 9.99. If only a pack/retail price is shown, still return it here and we will reconcile manually. Empty string if not visible."
}
