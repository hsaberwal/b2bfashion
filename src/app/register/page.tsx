    ...
    <main className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md border border-gray-200 rounded-xl p-6 shadow-sm bg-white dark:bg-gray-900 dark:border-gray-800">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
          Claudia.C B2B — pricing is granted after approval
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Honeypot — off-screen, not tab-reachable, ignored by screen readers.
              Real users never see or fill this. Bots that fill every input get rejected. */}
