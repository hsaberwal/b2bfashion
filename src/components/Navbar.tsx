        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            <>
              <Link
                href="/account"
                className="flex items-center gap-2 text-je-muted hover:text-je-black transition-colors"
              >
              ...
              <button
                ...
                title="Log out"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="sm:hidden">
